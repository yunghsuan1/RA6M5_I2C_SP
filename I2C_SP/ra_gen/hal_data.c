...
const i2c_slave_cfg_t g_i2c_slave2_cfg =
{ .channel = 2, .rate = I2C_SLAVE_RATE_STANDARD, .slave = 0x4B, .general_call_enable = false, .addr_mode =
...
#endif
  .ipl = (12),
  .eri_ipl = (12), .clock_stretching_enable = false, .p_extend = &g_i2c_slave2_extend, };
/* Instance structure to use this module. */
const i2c_slave_instance_t g_i2c_slave2 =
{ .p_ctrl = &g_i2c_slave2_ctrl, .p_cfg = &g_i2c_slave2_cfg, .p_api = &g_i2c_slave_on_iic };
...
{ .channel = 1, .rate = I2C_SLAVE_RATE_STANDARD, .slave = 0x4A, .general_call_enable = false, .addr_mode =
          I2C_SLAVE_ADDR_MODE_7BIT,
#if (IIC_SLAVE_CFG_DTC_ENABLE)
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
...
{ .channel = 0, .rate = I2C_MASTER_RATE_STANDARD, .slave = 0x4A, .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
#define RA_NOT_DEFINED (1)
#if (RA_NOT_DEFINED == RA_NOT_DEFINED)
  .p_transfer_tx = NULL,
#else
